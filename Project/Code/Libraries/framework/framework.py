...
class FrameWork():
    ...
    SOURCE_FOLDER_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..', "Data/Source"))
    PROMPT_FOLDER_PATH = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../..', "Data/Prompt"))
    ...
    def read_config_file(self) -> None:
        ...
        Dictionary is accessible from FrameWork instance
